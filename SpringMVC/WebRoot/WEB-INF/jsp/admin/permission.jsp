...
<c:if test="${rbac:hasPermission(activeUserInfo.id, '/permission/delete')}">
	<script type="text/javascript">
		$.canDelete = true;
	</script>
</c:if>
<script type="text/javascript">
	...
	function deleteFun(id) {
		...
		if (node) {
			parent.$.messager.confirm('询问', '您是否要删除当前权限？', function(b) {
				if (b) {
...
<body>
	...
	<div id="toolbar" style="display: none;">
		<c:if test="${rbac:hasPermission(activeUserInfo.id, '/permission/addPage')}">
