		...
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					--%>
					<th>用户名</th>
					<td><input name="username" type="text" placeholder="请输入登录名称" class="easyui-validatebox span2" data-options="required:true" value="${user.username}"></td>
					<th>昵称</th>
					<td><input name="nickname" type="text" placeholder="请输入登录名称" class="easyui-validatebox span2" data-options="required:true" value="${user.nickname}"></td>
				</tr>
				<tr>
					<th>状态</th>
