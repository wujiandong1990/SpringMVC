...
<script type="text/javascript">
	$(function() {
		...
		$('#organizationIds').combotree({
			...
			cascadeCheck : false,
			value : $.stringToList('${user.organizationIds}')
		});

		$('#form').form({
			url : '${baseUrl}/user/setOrg',
			onSubmit : function() {
		...
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>所属机构</th>
					<td><select id="organizationIds" name="organizationIds" style="width: 280px; height: 29px;"></select><img src="${baseUrl}/resources/style/images/extjs_icons/cut_red.png" onclick="$('#organizationIds').combotree('clear');" /></td>
				</tr>
			</table>
		</form>
	</div>
