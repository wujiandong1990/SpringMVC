...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="${baseUrl}/resources/jslib/plupload-2.1.9/js/jquery.plupload.queue/css/jquery.plupload.queue.css" media="screen" />
<script type="text/javascript" src="${baseUrl}/resources/jslib/plupload-2.1.9/js/jquery.plupload.queue/jquery.plupload.queue.min.js" charset="UTF-8"></script>
